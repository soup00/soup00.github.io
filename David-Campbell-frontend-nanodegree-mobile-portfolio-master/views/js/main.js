...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) { // Place randomPizzaContainer in a function
        var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer");
        var dx = determineDx(randomPizzaContainer[0], size);
        var newwidth = (randomPizzaContainer[0].offsetWidth + dx) + 'px'; // Loop thru pizza contaier and change the width
...
function updatePositions() {
    ...
    var items = document.getElementsByClassName('mover'); // changed to getElementsByClassName from querySelectorAll
    var itemsLength = items.length; // hold length of item
    var phase; //put the phase var outside the loop
    var scrolledTop = document.body.scrollTop / 1250;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var totalPizzas = document.querySelector("#movingPizzas1");
